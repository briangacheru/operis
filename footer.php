<footer class="footer">
    <div class="row g-0 justify-content-between fs-10 mt-4 mb-3">
        ...
        <div class="col-12 col-sm-auto text-center">
            <p class="mb-0 text-600"><?php echo getVersionNumber(); ?></p>
        </div>
    </div>
</footer>
</div>
        ...
        <div class="modal-content border-0">
            <div class="modal-header px-5 position-relative modal-shape-header bg-shape">
                <div class="position-relative z-1">
                    <h4 class="mb-0 text-white" id="authentication-modal-label">View Overdraft</h4>
                </div>
            ...
            <div class="modal-body py-4 px-5">
                ...
                <form id="overdraft-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" autocomplete="on" name="writer" id="modal-auth-name" disabled />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="modal-auth-amount">Amount</label>
                        <input class="form-control" type="number" autocomplete="on" name="amount" id="modal-auth-amount" disabled />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="modal-auth-date">Date</label>
                        <input class="form-control datetimepicker" disabled type="text" autocomplete="on" name="od_date" readonly id="modal-auth-date" placeholder="YYYY-mm.dd H:i" data-options='{"enableTime":true,"dateFormat":"Y-m-d H:i","disableMobile":true,"allowInput":true}' />
                    </div>
                </form>
            </div>
        </div>
