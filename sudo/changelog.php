                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <!--<div class="create-product-description-textarea">
                                            <div class="formatting-toolbar">
                                                <button type="button" onclick="wrapSelection('**', '**')" title="Bold"><i class="fas fa-bold"></i></button>
                                                <button type="button" onclick="wrapSelection('_', '_')" title="Italic"><i class="fas fa-italic"></i></button>
                                                <button type="button" onclick="wrapSelection('# ', '')" title="Heading 1"><i class="fas fa-heading"></i></button>
                                                <button type="button" onclick="wrapSelection('## ', '')" title="Heading 2"><i class="fas fa-heading"></i></button>
                                                <button type="button" onclick="wrapSelection('### ', '')" title="Heading 3"><i class="fas fa-heading"></i></button>
                                                <button type="button" onclick="insertBullet()" title="Bullet List"><i class="fas fa-list-ul"></i></button>
                                                <button type="button" onclick="insertNumberedList()" title="Numbered List"><i class="fas fa-list-ol"></i></button>
                                                ...
                                                <button type="button" onclick="insertCodeBlock()" title="Code Block"><i class="fas fa-code"></i></button>
                                                <button type="button" onclick="addLineBreak()" title="New Line"><i class="fas fa-level-down-alt"></i></button>
                                            </div>
                                            <textarea class="form-control" name="description" id="description" required="required" style="width: 100%; height: 200px;"></textarea>
                                            <div class="invalid-feedback">This field is required</div>
                                        </div>-->
                                    </div>
                                </div>
