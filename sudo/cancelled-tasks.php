                                        ...
                                        <tr class="hover-actions-trigger btn-reveal-trigger hover-bg-100">
                                            ...
                                            <td class="align-middle white-space-nowrap text-end position-relative">
                                                <div class="hover-actions bg-100">
                                                    ...
                                                    <a class="btn bg-success-subtle icon-item rounded-3 me-2 fs-11 icon-item-sm" href="cancelled-tasks?task_id=<?php echo $encodedId; ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Restore Task" onclick="return confirm('Do you want to restore this task?');"><span class="fas fa-recycle"></span></a>
                                                </div>
