...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>iTasker | Dashboard &amp; Web App Template</title>
...
<main class="main" id="top">
    <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6 text-center">
            <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5"><a class="d-flex flex-center mb-4" href="index"><img class="me-2" src="../assets/img/icons/spot-illustrations/itasker.png" alt="" width="58" /><span class="font-sans-serif text-primary fw-bolder fs-4 d-inline-block">itasker</span></a>
                <div class="card">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <hr />
                        <p>Make sure the address is correct and that the page hasn't moved. If you think this is a mistake, <a href="mailto:support@monkbrian.com">contact us</a>.</p><a class="btn btn-primary btn-sm mt-3" href="index"><span class="fas fa-home me-2"></span>Take me home</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
    ...
    <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
        ...
        <div class="text-center mt-5"><img class="mb-4" src="../assets/img/icons/spot-illustrations/47.png" alt="" width="120" />
            ...
            <p class="fs-10">Get Falcon now and create beautiful dashboards with hundreds of widgets.</p><a class="mb-3 btn btn-primary" href="https://themes.getbootstrap.com/product/falcon-admin-dashboard-webapp-template/" >Purchase</a>
        </div>
    </div>
