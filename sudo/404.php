...
<main class="main" id="top">
    <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6 text-center">
            <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5"><a class="d-flex flex-center mb-4" href="index.php"><img class="me-2" src="../assets/img/icons/spot-illustrations/itasker.png" alt="" width="58" /><span class="font-sans-serif text-primary fw-bolder fs-4 d-inline-block">itasker</span></a>
                <div class="card">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <hr />
                        <p>Make sure the address is correct and that the page hasn't moved. If you think this is a mistake, <a href="mailto:support@monkbrian.com">contact us</a>.</p><a class="btn btn-primary btn-sm mt-3" href="index.php"><span class="fas fa-home me-2"></span>Take me home</a>
                    </div>
                </div>
            </div>
        </div>
