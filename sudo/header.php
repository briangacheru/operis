                ...
                <div class="navbar-vertical-content scrollbar">
                    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                        ...
                        <li class="nav-item">
                            ...
                            <!-- parent pages--><a class="nav-link" href="create-task.php" role="button">
                      ...
                      ?></span>
                       ...
                       ?></span>
                            ...
                            <!-- parent pages--><a class="nav-link" href="tasks-in-progress.php" role="button">
                        ...
                        ?></span>
                            ...
                            <!-- parent pages--><a class="nav-link" href="cancelled-tasks.php" role="button">
                        ...
                        ?></span>
                            ...
                            <!-- parent pages--><a class="nav-link" href="archived-tasks.php" role="button">
                        ...
                        ?></span>
                            ...
                            <!-- parent pages--><a class="nav-link" href="favorited-tasks.php" role="button">
...
<!--                                        <div class="col-auto ps-0 ps-sm-3"><a class="card-link fw-normal" href="#">Mark all as read</a></div>-->
                                    ...
                                    <div class="list-group list-group-flush fw-normal fs-10">
                                        ...
                                        <?php foreach ($lateTasks as $key => $task): ?>
                                            <div class="list-group-item"><?php
                                                ...
                                                ?>
                                                <a class="notification notification-flush notification-unread" href="view-task.php?task_id=<?php echo htmlspecialchars($encodedId); ?>">
                                                    <div class="notification-avatar">
                                                        <div class="avatar avatar-2xl me-3">
                                ...
                                <div class="card-footer text-center border-top"><a class="card-link d-block" href="tasks-in-progress.php">View all</a></div>
                            </div>
                        </div>
                    </li>
                    <?php
