...
// Auto-archive paid completed tasks older than 4 months
mysqli_query($con, "UPDATE tbltasks 
                    SET is_archived = 1 
                    WHERE is_deleted = 0 
                      ...
                      AND completed_on < DATE_SUB(NOW(), INTERVAL 4 MONTH)");
?>
                                            ...
                                            <tr class="hover-actions-trigger btn-reveal-trigger hover-bg-100">
                                                ...
                                                <td class="align-middle white-space-nowrap text-end position-relative">
                                                    <div class="hover-actions bg-100">
                                                        ...
                                                        <a class="btn bg-warning-subtle icon-item rounded-3 me-2 fs-11 icon-item-sm"  href="duplicate-task?task_id=<?php echo $encodedId; ?>" onclick="return confirm('Are you sure you want to duplicate this task?');" data-bs-toggle="tooltip" data-bs-placement="top" title="Duplicate Task"><span class="fas fa-copy"></span></a>
                                                    </div>
