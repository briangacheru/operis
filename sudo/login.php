...
// Get base path for subdirectory handling
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $loginError = "
            <div class='alert alert-danger alert-dismissible fade show' role='alert'>
                <i class='bi bi-exclamation-circle me-1'></i> Invalid email format.
                        ...
                        <div class="row g-0 h-100">
                            <div class="col-md-5 text-center bg-card-gradient">
                                <div class="position-relative p-4 pt-md-5 pb-md-7" data-bs-theme="light">
                                    ...
                                    <div class="z-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-5 d-inline-block fw-bolder" href="<?php echo $base_path; ?>/index">iTasker</a>
                                ...
                                <div class="mt-3 mb-4 mt-md-4 mb-md-5" data-bs-theme="light">
                                    <p class="text-white">Don't have an account?<br><a class="text-decoration-underline link-light" href="<?php echo $base_path; ?>/register">Get started!</a></p>
...
<?= csrf_field() ?>
                                        ...
                                        <div class="form-check form-switch mb-2">
                                            ...
                                            <label class="form-check-label fs-sm-11 text-500" for="showPassword">Show Password</label>
                                        </div>
                                        <div class="row flex-between-center">
                                            <div class="col-auto">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var showPasswordLabel = document.querySelector('label[for="showPassword"]');
