                                        ...
                                        <tr class="hover-actions-trigger btn-reveal-trigger hover-bg-100">
                                            ...
                                            <td class="align-middle white-space-nowrap text-end position-relative">
                                                <div class="hover-actions bg-100">
                                                    ...
                                                    <a class="btn bg-danger-subtle icon-item rounded-3 me-2 fs-11 icon-item-sm" href="unconfirmed.php?del=<?php echo $encodedId; ?>" title="Cancel Task" onclick="return confirm('Do you really want to cancel task?');"><span class="fas fa-trash"></span></a>
                                                </div>
