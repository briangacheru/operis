<footer class="footer">
    <div class="row g-0 justify-content-between fs-10 mt-4 mb-3">
        <div class="col-12 col-sm-auto text-center">
            <p class="mb-0 text-600">Developed with <i class="fa fa-heart"></i> by Brian  <span class="d-none d-sm-inline-block">| </span><br class="d-sm-none" />2023 - <?php echo date("Y");?> &copy; </p>
        </div>
        <div class="col-12 col-sm-auto text-center">
