...
if (isset($_GET['task_id'])) {
    ...
    if ($row = mysqli_fetch_assoc($result)) {
        ...
        $duplicateQuery = "INSERT INTO tbltasks (topic, subject, account, description, writer, email, due_date, cpp, pages, is_confirmed, is_duplicate, task_files) 
                           VALUES ('$topic', '$subject', '$account', '$description', '$writer', '$writerEmail', '$due_date', '$cpp', '$pages', '$is_confirmed', '$is_duplicate', '$filesString')";
