...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($errors)) {
        ...
        $stmt = $con->prepare("INSERT INTO tbladmin (username, email, password) VALUES (?, ?, ?)");
        ...
        if ($stmt->execute()) {
            ...
            $user_mail->isSMTP();
            $user_mail->Host = 'mail.monkbrian.com';
            ...
            $admin_mail->isSMTP();
            $admin_mail->Host = 'mail.monkbrian.com';
...
<main class="main" id="top">
    ...
    $query = "SELECT regStatus FROM tblsettings WHERE id = 2"; // Assuming there's only one record
                            ...
                            <div class="col-md-7 d-flex flex-center">
                                <div class="p-4 p-md-5 flex-grow-1">
                                    <div class="text-center"><img class="d-block mx-auto mb-4" src="../assets/img/icons/spot-illustrations/45.png" alt="shield" width="100" />
                                        ...
                                        <p>Thanks for your interest in signing up but registration is closed for now!</p><a class="btn btn-primary btn-sm mt-3" href="login.php"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to Login</a>
                                    </div>
                                </div>
                            </div>
                        </div>
