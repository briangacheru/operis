...
<form action="" method="get" id="select">
    ...
    <input type="checkbox" name="standalone" value="1" data-bs-toggle="tooltip" data-bs-placement="top" title="Standalone version?" <?php if($this->ac['standalone']) {echo 'checked="checked" ';} ?>/>
