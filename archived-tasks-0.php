        ...
        <div class="card-header z-1">
            <div class="row flex-between-center gx-0">
                <div class="col-lg-auto d-flex align-items-center">
                    <h4 class="mb-0 text-primary fw-bold">Archived <span class="text-info fw-medium"> Tasks</span></h4>
                </div>
                            ...
                            <form id="tasksForm" method="post">
                                    ...
                                    <div class="row flex-between-center">
                                        ...
                                        <div class="col-6 col-sm-auto ms-auto text-end ps-0">
                                            ...
                                            <div class="d-flex align-items-center" id="table-simple-pagination-replace-element">
                                                <a class="btn btn-falcon-info btn-sm mx-2" href="create-task.php" data-bs-toggle="tooltip" data-bs-placement="top" title="Create Task" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ms-1">New Task</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-0">
                                    <table class="table table-sm mb-0 overflow-hidden data-table fs-10"  data-datatables="data-datatables">
                                        ...
                                        <?php
                                        $query=mysqli_query($con,"select * from tbltasks WHERE is_deleted = 0 AND is_archived = 1 ORDER BY id DESC");
                                        $cnt=1;
