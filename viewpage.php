...
?>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body position-relative">
            <h5>Task ID: #2737</h5>
            <p class="fw-semi-bold fs-10"><span class="me-1">Posted</span><span class="text-info ms-2">April 21, 2019, 5:33 PM</span>
            </p>
    ...
    <div class="card overflow-hidden mb-3" data-bs-theme="light">
        <div class="card-body bg-black">
            <div class="bg-holder rounded-3" style="background-image:url(assets/img/illustrations/corner-6.png);">
            </div>
            <!--/.bg-holder-->
            ...
            <div class="row">
                <div class="col-xl-8 position-relative">
                    <div class="row g-3 align-items-center">
                        <div class="col-lg-12">
                            <h6 class="fw-semi-bold text-400"><span class="fas fa-school text-white me-1"> </span>Psychology</h6>
                            <h2 class="fw-bold text-white">Advanced Design Tools for Modern Designs </h2>
                            <p class="text-white fw-semi-bold fs-10"><span class="me-1">Due</span><span class="text-info ms-2">April 21, 2019, 5:33 PM</span>
                            </p>
                            <p class="mb-0 fw-medium text-400">
                                Description: Exploring Photoshop, Illustrator, Krita, Procreate, and Canva; trace the evolution of graphic design from ancient...<a class="text-info" href="#!">
                                    See more</a></p>
                        </div>
                    </div>
                    <hr class="text-secondary text-opacity-50" />
                    <ul class="list-unstyled d-flex flex-wrap gap-3 fs-10 fw-semi-bold text-300 mt-3 mb-0">
                        <li><span class="fas fa-user-graduate text-white me-1"> </span>Writer</li>
                        <li><span class="fas fa-user text-white me-1"> </span>Account</li>
                        <li><span class="fas fa-file text-white me-1"> </span>Pages</li>
                        <li><span class="fas fa-dollar-sign text-white me-1"> </span>CPP</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row g-lg-3">
        <div class="col-lg-8 order-1 order-lg-0">
            ...
            <div class="card mb-3">
                <div class="card-header bg-body-tertiary">
                    <h5 class="mb-0">Submitted Files</h5>
                </div>
                <div class="card-body position-relative">
                    <div class="bg-holder bg-card d-none d-md-block" style="background-image:url(assets/img/icons/spot-illustrations/corner-7.png);">
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-7 col-lg-12 order-md-1 order-lg-0">
                                <h2 class="fw-medium d-flex align-items-center">Ksh. 47.49
                                </h2>
                                <p class="text-danger fs-10 fw-semi-bold"><span class="far fa-clock me-2"></span>Time remaining: 13h : 25m : 54s</p>
                                <button class="btn btn-primary btn-lg w-100 fs-9 mt-1" id="course-purchase-btn">Submit Task</button>
                            </div>
                            <div class="col-md-5 col-lg-12">
                                <hr class="border-top border-dashed d-md-none d-lg-block" />
                                <h6 class="fw-bold">Other Task Details</h6>
                                <ul class="list-unstyled fs-10 mb-0">
                                    <li class="mb-1"><span class="fs-11 fas fa-check me-2"></span>Payment</li>
                                </ul>
                            </div>
                        </div>
